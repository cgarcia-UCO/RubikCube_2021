...
class RubicCube:
    ...
    def rotateAntiLeftClockwise(self):
...
if __name__=="__main__":
    ...
    c2.write("/home/fernando/Documentos/practicasSIN/RubikCube_2021/frontRotate.txt")
    c2.print()
    ...
    c2.print()
    print('\n\n----------------------------')
    print('-------ANTILEFT ROTATION---------')
    c2 = RubicCube()
    #c2=c.clone()
    c2.rotateAntiLeftClockwise()
    c2.write("/home/fernando/Documentos/practicasSIN/RubikCube_2021/frontRotate.txt")
    c2.print()
